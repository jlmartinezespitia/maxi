						...
						<tbody>
							@foreach($cart as $item)
								<tr>
									...
									<td><a href="#" class="btn btn-warning edit-item" data-url={{url("/")}} data-slug="{{$item->slug}}" data-id="{{$item->id}}" data-precio="{{$item->precio}}" data-cantidad="{{$item->cantidad}}"><i class="fa fa-edit"></i></a></td>
